...
| `--with-compact-maas`
| Also run Phase 10 (Compact MaaS; sibling `compact-maas`)
|
...
| 10
| Compact MaaS (optional) - thin native UI into `compact-maas`
| 5-15 min
|===
...
Then register OpenAI-compatible SaaS or IBM RHAI models per xref:08-external-models.adoc[Phase 8: External Models] (Compact MaaS Admin *Upstream path prefix*, or YAML templates under `manifests/08-external-models/openai-compatible-prefixed/`).
